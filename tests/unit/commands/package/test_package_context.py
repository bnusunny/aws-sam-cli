...
class TestPackageContextLanguageExtensions(TestCase):
    ...
    def test_update_original_template_with_s3_uris_preserves_foreach(self):
        ...
        result = package_context._update_original_template_with_s3_uris(original_template, exported_template)
    ...
    def test_copy_artifact_uris_for_type_serverless_function(self):
        ...
        result = package_context._copy_artifact_uris_for_type(
            original_props, exported_props, "AWS::Serverless::Function"
        )
    ...
    def test_copy_artifact_uris_for_type_lambda_function(self):
        ...
        result = package_context._copy_artifact_uris_for_type(original_props, exported_props, "AWS::Lambda::Function")
    ...
    def test_copy_artifact_uris_for_type_serverless_layer(self):
        ...
        result = package_context._copy_artifact_uris_for_type(
            original_props, exported_props, "AWS::Serverless::LayerVersion"
        )
    ...
    def test_copy_artifact_uris_for_type_serverless_api(self):
        ...
        result = package_context._copy_artifact_uris_for_type(original_props, exported_props, "AWS::Serverless::Api")
    ...
    def test_copy_artifact_uris_for_type_unknown_type(self):
        ...
        result = package_context._copy_artifact_uris_for_type(original_props, exported_props, "AWS::Unknown::Resource")
    ...
    def test_update_foreach_with_s3_uris_multiple_resource_types(self):
        ...
        package_context._update_foreach_with_s3_uris("Fn::ForEach::Resources", foreach_value, exported_resources)
    ...
    def test_update_foreach_with_s3_uris_invalid_foreach_structure(self):
        ...
        package_context._update_foreach_with_s3_uris("Fn::ForEach::Test", "invalid", {})

        # Test with list that's too short
        package_context._update_foreach_with_s3_uris("Fn::ForEach::Test", ["Name", ["Alpha"]], {})

        # Test with non-dict body
        package_context._update_foreach_with_s3_uris("Fn::ForEach::Test", ["Name", ["Alpha"], "invalid"], {})
    ...
    def test_replace_dynamic_artifact_with_findmap_basic(self):
        ...
        result = package_context._replace_dynamic_artifact_with_findmap(resources, prop)
    ...
    def test_replace_dynamic_artifact_with_findmap_preserves_foreach_structure(self):
        ...
        package_context._replace_dynamic_artifact_with_findmap(resources, prop)
    ...
    def test_apply_artifact_mappings_to_template_integration(self):
        ...
        result = package_context._apply_artifact_mappings_to_template(template, mappings, dynamic_properties)
...
class TestPackageContextMappingsIntegration(TestCase):
    ...
    def test_export_with_dynamic_artifact_properties_generates_mappings(self):
        """Test that _export() generates Mappings for dynamic artifact properties"""
        from samcli.lib.samlib.wrapper import DynamicArtifactProperty
        ...
        dynamic_properties = detect_dynamic_artifact_properties(original_template, package_context.parameter_overrides)
        ...
        output_template = package_context._update_original_template_with_s3_uris(
            original_template, exported_template, dynamic_properties
        )

        # Generate Mappings
        exported_resources = exported_template.get("Resources", {})
        mappings, _ = package_context._generate_artifact_mappings(dynamic_properties, "/tmp", exported_resources)

        # Apply Mappings to template
        output_template = package_context._apply_artifact_mappings_to_template(
    ...
    def test_export_with_static_artifact_properties_no_mappings(self):
        """Test that _export() does not generate Mappings for static artifact properties"""
        package_context = PackageContext(
            template_file="template-file",
            s3_bucket="s3-bucket",
            s3_prefix="s3-prefix",
    ...
    def test_update_original_template_skips_dynamic_properties(self):
        """Test that _update_original_template_with_s3_uris skips dynamic properties"""
        from samcli.lib.samlib.wrapper import DynamicArtifactProperty
        ...
        result = package_context._update_original_template_with_s3_uris(
            original_template, exported_template, dynamic_properties
        )
    ...
    def test_detect_dynamic_artifact_properties_with_fn_sub(self):
        ...
        dynamic_properties = detect_dynamic_artifact_properties(template, package_context.parameter_overrides)
    ...
    def test_find_artifact_uri_for_resource(self):
        ...
        result = package_context._find_artifact_uri_for_resource(
        ...
        result = package_context._find_artifact_uri_for_resource(
            exported_resources, "LambdaFunction", "AWS::Lambda::Function", "Code"
        )
        ...
        result = package_context._find_artifact_uri_for_resource(
            exported_resources, "UsersService", "AWS::Lambda::Function", "Code"
        )
        self.assertIsNone(result)
...
class TestDynamicArtifactPropertyDetection(TestCase):
    ...
    **Validates: Requirements 15.11**
    ...
    def _create_package_context(self, parameter_overrides=None):
        """Helper to create a PackageContext instance for testing."""
    ...
    def test_detect_loop_variable_in_codeuri_simple_string(self):
        ...
        package_context = self._create_package_context()
...
class TestPackageContextParameterBasedCollectionWarning(TestCase):
    ...
    def test_warn_parameter_based_collections_emits_warning(self, mock_click):
        ...
        package_context._warn_parameter_based_collections(dynamic_properties)
...
class TestPackageContextMappingKeyValidation(TestCase):
    ...
    def test_validate_mapping_key_compatibility_valid_alphanumeric(self):
        ...
        package_context._validate_mapping_key_compatibility(prop)
...
class TestBuildToPackageFlow(TestCase):
    ...
    def test_detect_dynamic_properties_from_build_output(self):
        ...
        dynamic_properties = detect_dynamic_artifact_properties(
            build_output_template, package_context.parameter_overrides
        )
    ...
    def test_apply_mappings_replaces_build_mappings(self):
        ...
        result = package_context._apply_artifact_mappings_to_template(template, new_mappings, dynamic_properties)
